...
%   DATA1 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for the default selection.
%
%   DATA1 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of
%   text file FILENAME.
%
% Example:
%   data1 = importfile1('data.log', 1, 1301);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/10/28 17:26:35
